...
namespace LEdit_V1_Server
{
    ...
    public class ActionRunner
    {
        ...
        public static string RunPasswordChanger(string[] dataParams)
        {
            string res = Download($"{Settings.API.api_link}?action=ChangePassword&username={dataParams[1]}&newPass={dataParams[3]}", dataParams[1], dataParams[2]);
            if (res == "True")
            {
                RefreshLoginCache();
            }
        ...
        public static void RefreshLoginCache()
        {
...
namespace Settings
{
    ...
    {
        public static string ip_addr = "81.4.111.219"; // The server IP address
    ...
    {
        public static string api_link = "http://localhost/api/api.php"; // Link to the api.php file that you installed on your web server
    }
}
